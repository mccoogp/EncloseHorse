...
while running:
    ...
    # Buttons
    rows_btn = draw_button("Rows", board_w+20, 20, 120, 40)
    plus_btn = draw_button("+", board_w+20, 80, 50, 40)
    minus_btn = draw_button("-", board_w+90, 80, 50, 40)
    column_btn = draw_button("Columns", board_w+20, 140, 120, 40)
    plus2_btn = draw_button("+", board_w+20, 200, 50, 40)
    minus2_btn = draw_button("-", board_w+90, 200, 50, 40)
    done_btn = draw_button("Done?", board_w+20, 260, 120, 40)
    ...
    for event in pygame.event.get():
        ...
        if event.type==pygame.MOUSEBUTTONDOWN:
            ...
            if plus2_btn.collidepoint(mx,my) and mode=="EDIT":
                resize(rows+1, cols)
            ...
            elif done_btn.collidepoint(mx,my) and mode=="EDIT":
                 running=False
